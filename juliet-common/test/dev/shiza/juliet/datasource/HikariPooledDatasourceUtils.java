...
import dev.shiza.juliet.hikari.HikariConfigBuilder;
import dev.shiza.juliet.hikari.HikariPooledDataSourceFactory;
...
public final class HikariPooledDatasourceUtils {
  ...
  public static PooledDataSource getHikariDataSourceByContainer(final MySQLContainer<?> container) {
    return HikariPooledDataSourceFactory.create(
